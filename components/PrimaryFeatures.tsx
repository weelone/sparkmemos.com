...
function OverviewScreen(props: ScreenProps) {
  return (
...
function CollectionsScreen(props: ScreenProps) {
  return (
    <AppScreen className="w-full">
      <Image
        className="relative -top-7"
        ...
        {getFeatures(dict).map((feature, featureIndex) => (
          ...
          >
            <div className="relative transform overflow-hidden rounded-2xl bg-stone-800 px-5 py-6">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-stone-800/95 p-6 backdrop-blur sm:p-10">
                <feature.icon className="h-8 w-8" />
...
export function PrimaryFeatures({ dict }: { dict: Dictionary }) {
  return (
    <section
      ...
      className="bg-stone-900 py-20 sm:py-32"
    >
      <Container>
